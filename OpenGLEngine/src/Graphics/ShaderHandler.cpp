...
void ShaderHandler::CreateProgram(const std::string& shaderName_, const std::string& vertexShaderFile_, const std::string& fragmentShaderFile_)
{
	std::string vertexShaderCode = ReadShader(vertexShaderFile_);
	std::string fragmentShaderCode = ReadShader(fragmentShaderFile_);
